// src/components/background/enhanced-skills.tsx
...
import { AnimatedOnScroll, useAnimation } from '../AnimationProvider';
  ...
  return (
    <section id="skills" className="py-20 px-6 bg-gray-900 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        {/* Search Bar */}
        <AnimatedOnScroll animation="fade-in" delay={200} className="max-w-md mx-auto mb-8">
        ...
        <AnimatedOnScroll animation="fade-in" delay={300} className="flex flex-wrap justify-center mb-10 gap-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
          {filteredSkills.map((skill, index) => (
            <div
              key={skill.name}
              className={`
                bg-gray-800 rounded-lg overflow-hidden shadow-md relative transform transition-all duration-500
                ${visibleItems[index] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}
                ${expandedSkill === skill.name ? 'scale-105 shadow-xl ring-1 ring-indigo-500/50' : 'hover:shadow-lg hover:-translate-y-1'}
              `}
              style={{
                transitionDelay: settings.preferReducedMotion ? '0ms' : `${index * 50}ms`,
            ...
            >
              ...
              <div className="p-4 flex items-center justify-between cursor-pointer">
                <div className="flex items-center">
                  <div className={`
                    ...
                    ${expandedSkill === skill.name ? 'scale-110 rotate-6' : ''}
                  `}>
                    {skill.icon}
                  </div>
              ...
              <div
                className={`
                  ...
                  ${expandedSkill === skill.name ? 'max-h-64 opacity-100' : 'max-h-0 opacity-0'}
                `}
              >
                <div className="p-4">
        ...
        <AnimatedOnScroll animation="fade-in-up" delay={400} className="mt-16 bg-gray-800 p-6 rounded-lg shadow-xl max-w-3xl mx-auto">
